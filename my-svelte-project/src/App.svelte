...
const service_name = 'app5!';
    ...
    try {
        ...
        const response = await fetch(endpoint + '/app5/read', {
            method: 'POST',
            headers: {
...
async function create_record() {
    try {
        ...
        const response = await fetch(endpoint + '/app5/create', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function update_record(id) {
    try {
        ...
        if (confirm('更新しますか？')) {
            const response = await fetch(endpoint + '/app5/update', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
async function delete_record(id) {
    try {
        const response = await fetch(endpoint + '/app5/delete', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
